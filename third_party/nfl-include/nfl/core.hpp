...
#include <numeric>
#include <algorithm>
#include <cmath>   // [blns23-kv vendor patch] for log2
#include <cstring> // [blns23-kv vendor patch] for memset
...
// [blns23-kv vendor patch] gaussian ctor/set definitions removed.
