...
// [blns23-kv vendor patch] FastGaussianNoise.hpp (MPFR-dependent) removed:
// this project does not use Gaussian sampling.

#include <iostream>
#include <algorithm>
// [blns23-kv vendor patch] <gmpxx.h> removed: GMP-dependent helpers stripped.
#include <array>
...
// [blns23-kv vendor patch] struct gaussian (FastGaussianNoise-based) removed.
...
public:
  ...
  */
  ...
  // [blns23-kv vendor patch] GMP helper class, mpz constructors/setters and
  // conversion helpers removed (unused by this project, avoids GMP dependency).
...
// [blns23-kv vendor patch] gmp.hpp include removed.
